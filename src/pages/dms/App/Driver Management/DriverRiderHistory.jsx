...
const rideHistoryData = [
    { tripId: 'TRIP001', driverId: 'DRV001', riderId: 'RID001', date: '2023-12-18', time: '7:20 AM', pickup: 'Main Street', drop: 'Park Avenue', fare: 15, paymentMode: 'Cash' },
    { tripId: 'TRIP002', driverId: 'DRV002', riderId: 'RID002', date: '2023-12-17', time: '11:00 AM', pickup: '5th Avenue', drop: 'Central Park', fare: 20, paymentMode: 'Card' },
    { tripId: 'TRIP003', driverId: 'DRV003', riderId: 'RID003', date: '2023-12-16', time: '5:00 PM', pickup: 'Market Square', drop: 'Beach Road', fare: 25, paymentMode: 'Wallet' },
    { tripId: 'TRIP004', driverId: 'DRV004', riderId: 'RID004', date: '2023-12-14', time: '7:20 AM', pickup: 'Broadway', drop: 'Ocean Drive', fare: 30, paymentMode: 'Cash' },
    { tripId: 'TRIP005', driverId: 'DRV005', riderId: 'RID005', date: '2023-12-12', time: '11:00 AM', pickup: 'King Street', drop: 'Downtown', fare: 22, paymentMode: 'Card' },
    { tripId: 'TRIP006', driverId: 'DRV006', riderId: 'RID006', date: '2023-12-10', time: '5:00 PM', pickup: 'Pine Road', drop: 'Airport', fare: 18, paymentMode: 'Wallet' },
    { tripId: 'TRIP007', driverId: 'DRV007', riderId: 'RID007', date: '2023-12-08', time: '7:20 AM', pickup: 'Main Street', drop: 'Park Avenue', fare: 15, paymentMode: 'Cash' },
    { tripId: 'TRIP008', driverId: 'DRV008', riderId: 'RID008', date: '2023-12-06', time: '11:00 AM', pickup: '5th Avenue', drop: 'Central Park', fare: 20, paymentMode: 'Card' },
    ...
    { tripId: 'TRIP010', driverId: 'DRV010', riderId: 'RID010', date: '2023-12-02', time: '7:20 AM', pickup: 'Broadway', drop: 'Ocean Drive', fare: 30, paymentMode: 'Cash' },
    ...
    { tripId: 'TRIP012', driverId: 'DRV012', riderId: 'RID012', date: '2023-11-29', time: '5:00 PM', pickup: 'Pine Road', drop: 'Airport', fare: 18, paymentMode: 'Wallet' },
    { tripId: 'TRIP013', driverId: 'DRV013', riderId: 'RID013', date: '2023-11-28', time: '7:20 AM', pickup: 'Main Street', drop: 'Park Avenue', fare: 15, paymentMode: 'Cash' },
    ...
    { tripId: 'TRIP015', driverId: 'DRV015', riderId: 'RID015', date: '2023-11-26', time: '5:00 PM', pickup: 'Market Square', drop: 'Beach Road', fare: 25, paymentMode: 'Wallet' },
];
                    ...
                    {paginate(filteredRides, rideHistoryPage).map((ride, index) => (
                        <tr key={index}>
                          ...
                          {/*   <td>
                            ...
                            <td>
                                <a   href="#" role="button" className='rider-id-link' onClick={() => navigate('/dms/rider/profile', { state: { trip: ride } })}>
                                    {ride.riderId}
                                </a>
                            </td>

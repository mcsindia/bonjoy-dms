...
const complaintData = [
    {
        ...
        driverId: 'DRV001',
        riderId: '1',
        date: '2023-12-18 7:00 AM',
        complaintType: 'Rude Behavior',
        status: 'Pending',
        remark: 'Passenger was impolite.',
    },
    {
        tripId: 'TRIP002',
        driverId: 'DRV002',
        riderId: '2',
        date: '2023-12-17 5:55 PM',
        complaintType: 'Late Payment',
        status: 'Resolved',
        remark: 'Payment was delayed by 30 minutes.',
    },
    {
        tripId: 'TRIP003',
        driverId: 'DRV003',
        riderId: '3',
        date: '2023-12-16 8:00 PM',
        complaintType: 'Cancellation',
        status: 'Pending',
        remark: 'Passenger canceled the ride at the last moment.',
    },
    // Add more complaints as needed
];

export const ComplaintByRider = () => {
        ...
        <AdminLayout>
                    ...
                    {paginate(filteredComplaints, complaintPage).map((complaint, index) => (
                        <tr key={index}>
                            ...
                            <td> <a
                                ...
                                onClick={() => handleRiderClick(complaint.rider_id)} // Handle rider click
                            >
                                {complaint.riderId}
                            </a></td>
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)}>
                <Modal.Header closeButton>
                    <Modal.Title>
                        {selectedComplaint ? `Trip Id: ${selectedComplaint.tripId}` : "No Complaint Selected"}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {selectedComplaint ? (
                        <div>
                            ...
                            <Row>
                                ...
                                <Col>{selectedComplaint.riderId || "N/A"}</Col>
                            </Row>
                            <Row>
